...
\begin{enumerate}
	...
	\item Determine factors/characteristics of a UAS operation which have impact on the likelihood of the chosen harm.
	\item Establish formals or tables to evaluate qualitatively the likelihoods based on the determined factors
	\item Extend ``SAIL determination'' step to cover the new harm.
	\item OSO (?) 
\end{enumerate}
...
For Harm Extension, further works need to be achieved to verify or improve the reasonableness of the decision table, especially Table \ref{tab:3D-SAIL}. Then we start to develop Threat Extension to complete the extension solution.
